...
\section{Kravspecifikation och systembeskrivning}
	Kravspecifikation från kurs PM ``Via telefon skall det gå att ringa upp enheten och få reda på temperaturen. vidare skall det gå att aktivera en eller flera av fyra funktioner (värmeelement som simuleras av ljusdioder). För avläsning av temperatur används DS18S20''
	\subsection{Kravspec}
