...
Systemet är som tidigare nämnt uppdelat i sex funktionsenheter, som presenteras närmare nedan.
	...
	och RS0 satt hög. Initieringscykeln börjar med att DTMF-modulen läser statusregistret och ger kommandon genom att skriva till kontrollregistret på MT8880C-kretsen enligt ett i databladet givet mönster. Se även sektion ~\ref{MT8880C} under~\nameref{hårdvara} för vidare beskrivning.
