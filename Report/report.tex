...
Funktionsutgångarna kan också styras lokalt med med bifogade knappsatsen. Aktuell status för funktionsutgångarna visas med lysdioder. 
	...
	I blockschema som återfinns i figur ~\ref{fig:blockschema1} och ~\ref{fig:blockschema2} visas respektive modul och uppdelningen på två CPLD samt dess kommunikationsvägar. \\\\

	\begin{figure} [H]
		  \centering
		      \includegraphics[width=1\textwidth]{BlockDiagramCPLD1.png}
			\label{fig:blockschema1}
	...
	\begin{figure}[H]
		  \centering
			...
			\label{fig:blockschema2}
		  	\caption{Blockdiagram för CPLD2}
	\end{figure}

	\begin{table} [H]
		\label{tab:uppdelningstabell}
		\caption{Tabell över CPLD och respektive uppgifter} 
	\begin{tabular}{l l}
