...
{\noindent \bf Originalspecifikation} \\\\
"Sommarstugekoll.\\

Via telefon skall det gå att ringa upp enheten och få reda på temperaturen. 
Vidare skall det gå att aktivera en eller flera av fyra funktioner (värmeelement som simuleras med ljusdioder). 
För avläsning av temperatur används DS18S20." \\\\
...
\section{Systembeskrivning}
	...
	siffra på telefonens knappsats som användaren tryckt på. DTMF-Mottagaren avkodar signalerna och skickar in den resulterande
...
available- och acknowledgesignaler.

{\noindent \bf Uppbyggnad}

Styrenheten är i sin tur modulärt uppbyggd, och har ett väl avgränsat interface mot varje annan delmodul.
...
uppdateringarna ut på de I/O-pinnar som används för funktionerna. 
...
Temperatursensorerna arbetar med en temperaturupplösning på 0.5°C, och här fås alltså därför en oexakthet.
Enligt temperatursensorns datablad gäller exaktheten på +/- 0.5°C i intervallet -10°C till +85°C.
Systemet arbetar med ett temperaturspann på +/- 32°C, allt utanför intervallet representeras som maxtemperaturen.
...
\section{Appendix}
	...
	\begin{tabular}{l c r}
		\\{\bf Namn} & {\bf Typ} & {\bf Beskrivning}\\
		IC1 & XC9572XL & CPLD m. Styrenhet och DTMF-Avkodning\\
		IC2 & XC9572XL & CPLD m. Temperaturavläsning och Ljudhantering 		
		IC3 & DS18S20  & Temperatursensor A\\
		IC4 & DS18S20  & Temperatursensor B\\
		IC5 & MT8880C  & DTMF Transceiver\\
		IC6 & ISD2560P & 60s. Ljudlagringskrets\\\\
		R1-R2 & 4.7kOhm & Pull-Up-mostånd
		R3 & 10kOhm & Pull-Up-mostånd
		R4 & 15kOhm & Pull-Down-mostånd
		R5-R18 & 1.5kOhm & LED-motstånd
		SW1 & Switch & ON/OFF-Switch
		LA & LED-Array & Temperatur-display
